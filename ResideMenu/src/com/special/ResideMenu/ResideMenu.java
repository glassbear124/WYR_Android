...
public class ResideMenu extends FrameLayout {
    ...
    private void setMyPadding(Rect rect) {
            ...
            if (hasNavBar(getContext())) {
                ...
                switch (manager.getDefaultDisplay().getRotation()) {
                    ...
                    case Surface.ROTATION_180:
                        ...
                        rect.bottom = rect.bottom+getNavBarHeight();
                        Log.v("steps","180");
                        break;
        ...
        Log.v("steps", "setting padding! "+rect.toString());
        setPadding(
    ...
    private int getNavBarDimen(String resourceString) {
        ...
        if (id > 0) {
            Log.v("steps",resourceString+": "+r.getDimensionPixelSize(id));
            return r.getDimensionPixelSize(id);
        } else {
            Log.v("steps",resourceString+": 0");
            return 0;
        }
    }
